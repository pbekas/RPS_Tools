...
export function WeeklyTimesheetPanel({ initialTimesheet, settings }: Props) {
    ...
    <div className="space-y-4 rounded-2xl border border-line bg-white/90 p-4 shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <span className="text-sm font-semibold text-ink">
          {formatHours(timesheet.total_hours)} total
        </span>
      ...
      <TimeClockEntries
        ...
        settings={settings}
        canRequestEdits={timesheet.status !== "approved" && timesheet.status !== "submitted"}
